...
<h3>Using CXBOX</h2>
<ul>
<li> <a href="https://document.cxbox.org/plugin/plugininstalling" target="_blank">download Intellij Plugin</a>, which adds platform specific autocomplete, inspection, navigation and code generation features.
</li>
<li>
