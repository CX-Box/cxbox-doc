...
The drop-down list of a multipleSelect is never narrower than the field and grows with the longest value, but no wider
...
#### How to add?
??? Example
    Change constant **multipleSelect_dropDownMaxCols** .
    ```
