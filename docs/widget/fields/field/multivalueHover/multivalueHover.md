...
??? Example
    ...
    **Step1** Add field **List** to corresponding **BaseEntity**.
    ...
    ```java
    --8<--
    {{ external_links.github_raw_doc }}/multivaluehover/basic/MyEntity224.java
    --8<--
    ```
    ...
    **Step 2** Add field **MultivalueField** to corresponding **DataResponseDTO**.
    ...
    ```java
    --8<--
    {{ external_links.github_raw_doc }}/multivaluehover/basic/MyExample224DTO.java
    --8<--
    ```
    ...
    === "List widget"
        **Step 3** Add to **_.widget.json_**.
        ...
        ```json
        --8<--
        {{ external_links.github_raw_doc }}/multivaluehover/basic/MyExample224List.widget.json
        --8<--
        ```
    ...
    === "Info widget"
        **Step 3** Add to **_.widget.json_**.
        ...
        ```json
        --8<--
        {{ external_links.github_raw_doc }}/multivaluehover/basic/MyExample224Info.widget.json
        --8<--
        ```
    ...
    === "Form widget"
        **Step 3** Add to **_.widget.json_**.
        ...
        ```json
        --8<--
        {{ external_links.github_raw_doc }}/multivaluehover/basic/MyExample224Form.widget.json
        --8<--
        ```
...
??? Example
    === "Calculated color"
        **Step 1**   Add `custom field for color` to corresponding **DataResponseDTO**. The field can contain a HEX color or be null.
        ```java
        --8<--
        {{ external_links.github_raw_doc }}/multivaluehover/color/MyExample225DTO.java
        --8<--
        ```   
        ...
        === "List widget"   
            **Step 2** Add **"bgColorKey"** :  `custom field for color`  to .widget.json.
            ```json
            --8<--
            {{ external_links.github_raw_doc }}/multivaluehover/color/MyExample225List.widget.json
            --8<--
            ```
        ...
        === "Info widget"
            **Step 2** Add **"bgColorKey"** :  `custom field for color`  to .widget.json.
            ...
            ```json
            --8<--
            {{ external_links.github_raw_doc }}/multivaluehover/color/MyExample225Info.widget.json
            --8<--
            ```
        === "Form widget"
            **Step 2** Add **"bgColorKey"** :  `custom field for color`  to .widget.json.
            ```json
            --8<--
            {{ external_links.github_raw_doc }}/multivaluehover/color/MyExample225Form.widget.json
            --8<--
            ```
    === "Constant color"
        === "List widget" 
            ...
            ```json
            --8<--
            {{ external_links.github_raw_doc }}/multivaluehover/colorconst/MyExample227List.widget.json
            --8<--
            ```
        ...
        === "Info widget"
            ...
            ```json
            --8<--
            {{ external_links.github_raw_doc }}/multivaluehover/colorconst/MyExample227Info.widget.json
            --8<--
            ```
        === "Form widget"
            Add **"bgColor"** :  `HEX color`  to .widget.json.
            ```json
            --8<--
            {{ external_links.github_raw_doc }}/multivaluehover/colorconst/MyExample227Form.widget.json
            --8<--
            ```
## Readonly/Editable
...
??? Example
    === "List widget"
        **Step 1** Add **@SearchParameter** to corresponding **DataResponseDTO**. (Advanced customization [SearchParameter](/advancedCustomization/element/searchparameter/searchparameter))
        ```java
        --8<--
        {{ external_links.github_raw_doc }}/multivaluehover/filtration/MyEntity234DTO.java
        --8<--
        ```
        ...
        **Step 2**  Add **fields.enableFilter** to corresponding **FieldMetaBuilder**.
        ```java
        --8<--
        {{ external_links.github_raw_doc }}/multivaluehover/filtration/MyExample233Meta.java:buildIndependentMeta
        --8<--
        ```
