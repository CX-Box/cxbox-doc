...
## Placeholder
`The placeholder` specifies a short hint that describes the expected value of an input field. The hint is displayed in the input field before the user enters a value.### How does it look?
=== "List widget"
