...
??? Example
    ...
    **Step1** Add **Long** field  to corresponding **BaseEntity**. 
    ...
    ```java
    --8<--
    {{ external_links.github_raw }}/percent/basic/MyEntity1.java
    --8<--
    ```
    ...
    **Step2** Add **Long** field  to corresponding **DataResponseDTO**.
    ...
    ```java
    --8<--
    {{ external_links.github_raw }}/percent/basic/MyExample1DTO.java
    --8<--
    ```
    ...
    === "List widget"
        **Step3** Add to **_.widget.json_**.
        ...
        ```json
        --8<--
        {{ external_links.github_raw }}/percent/basic/MyExample1List.widget.json
        --8<--
        ```
    === "Info widget"
        **Step3** Add to **_.widget.json_**.
        ...
        ```json
        --8<--
        {{ external_links.github_raw }}/percent/basic/MyExample1Info.widget.json
        --8<--
        ```
    ...
    === "Form widget"
        ...
        **Step3** Add to **_.widget.json_**.
        ...
        ```json
        --8<--
        {{ external_links.github_raw }}/percent/basic/MyExample1Form.widget.json
        --8<--
        ```
...
??? Example
    ...
    ```java
    --8<--
    {{ external_links.github_raw }}/percent/placeholder/MyExample7Meta.java:buildRowDependentMeta
    --8<--
    ```  
    === "List widget"
        **Works for List.**
...
??? Example
    === "Calculated color"
        **Step 1**   Add `custom field for color` to corresponding **DataResponseDTO**. The field can contain a HEX color or be null.
        ```java
        --8<--
        {{ external_links.github_raw }}/percent/color/MyExample73DTO.java
        --8<--
        ```    
        ...
        === "List widget"   
            **Step 2** Add **"bgColorKey"** :  `custom field for color`  to .widget.json.
            ```json
            --8<--
            {{ external_links.github_raw }}/percent/color/MyExample73List.widget.json
            --8<--
            ```   
        ...
        === "Info widget"
            **Step 2** Add **"bgColorKey"** :  `custom field for color`  to .widget.json.
            ```json
            --8<--
            {{ external_links.github_raw }}/percent/color/MyExample73Info.widget.json
            --8<--
            ```  
        ...
        === "Form widget"
            **Step 2** Add **"bgColorKey"** :  `custom field for color`  to .widget.json.
            ```json
            --8<--
            {{ external_links.github_raw }}/percent/color/MyExample73Form.widget.json
            --8<--
            ```  
    === "Constant color"
        === "List widget" 
            ...
            ```json
            --8<--
            {{ external_links.github_raw }}/percent/colorconst/MyExample3List.widget.json
            --8<--
            ```
        === "Info widget"
            Add **"bgColor"** :  `HEX color`  to .widget.json.
            ```json
            --8<--
            {{ external_links.github_raw }}/percent/colorconst/MyExample3Info.widget.json
            --8<--
            ```
        === "Form widget"
            Add **"bgColor"** :  `HEX color`  to .widget.json.  
            ```json
            --8<--
            {{ external_links.github_raw }}/percent/colorconst/MyExample3Form.widget.json
            --8<--
            ```
## Readonly/Editable
...
??? Example
    === "Editable"
        **Step1** Add mapping DTO->entity to corresponding **VersionAwareResponseService**.
        ```java
        --8<--
        {{ external_links.github_raw }}/percent/basic/MyExample1Service.java:doUpdateEntity
        --8<--
        ```   
        **Step2** Add **fields.setEnabled** to corresponding **FieldMetaBuilder**.
        ```java
        --8<--
        {{ external_links.github_raw }}/percent/basic/MyExample1Meta.java:buildRowDependentMeta
        --8<--
        ```          
        === "List widget"
            **Works for List.**
    ...
    === "Readonly"
        ...
        **Option 1** Enabled by default.
        ```java
        --8<--
        {{ external_links.github_raw }}/percent/ro/MyExample4Meta.java:buildRowDependentMeta
        --8<--
        ```       
...
??? Example
    === "List widget"
        **Step 1** Add **@SearchParameter** to corresponding **DataResponseDTO**. (Advanced customization [SearchParameter](/advancedCustomization/element/searchparameter/searchparameter))
        ```java
        --8<--
        {{ external_links.github_raw }}/percent/filtration/MyExample6DTO.java
        --8<--
        ```   
        ...
        **Step 2**  Add **fields.enableFilter** to corresponding **FieldMetaBuilder**.
        ```java
        --8<--
        {{ external_links.github_raw }}/percent/filtration/MyExample6Meta.java:buildIndependentMeta
        --8<--
        ```   
...
??? Example
    ...
    **Option 1**
    ...
    ```java
    --8<--
    {{ external_links.github_raw }}/percent/drilldown/MyExample5Meta.java:buildRowDependentMeta
    --8<--
    ```   
    === "List widget"
        ...
        ```json
        --8<--
        {{ external_links.github_raw }}/percent/drilldown/MyExample5List.widget.json
        --8<--
        ```   
        **Option 2**
    ...
    === "Info widget"
        ...
        ```json
        --8<--
        {{ external_links.github_raw }}/percent/drilldown/MyExample5Info.widget.json
        --8<--
        ``` 
        **Option 2**
           Add **"drillDownKey"** :  `custom field`  to .widget.json. See more [Drilldown](/advancedCustomization/element/drillDown/drillDown) 
...
??? Example
    === "BusinessException"
        ...
        ```java
        --8<--
        {{ external_links.github_raw }}/percent/validationbusinessex/MyExample10Service.java:doUpdateEntity
        --8<--
        ```
        === "List widget"
            **Works for List.**
    ...
    === "RuntimeException"
        ...
        ```java
        --8<--
        {{ external_links.github_raw }}/percent/validationruntimeex/MyExample12Service.java:doUpdateEntity
        --8<--
        ```
        === "List widget"
            **Works for List.**
    ...
    === "Confirm"
        ...
        ```java
        --8<--
        {{ external_links.github_raw }}/percent/validationconfirm/MyExample11Service.java:getActions
        --8<--
        ```
        === "List widget"
            **Works for List.**
    ...
    === "Field level validation"
        === "Option 1"
            ...
            ```java
            --8<--
            {{ external_links.github_raw }}/percent/validationannotation/MyExample292DTO.java
            --8<--
            ```               
            === "List widget"
                **Works for List.**
        ...
        === "Option 2"
            ...
            ```java
            --8<--
            {{ external_links.github_raw }}/percent/validationdynamic/MyExample328Service.java:validateFields
            --8<--
            ```   
            `Step 2` Add сustom method for check to corresponding **VersionAwareResponseService**.
            ```java
            --8<--
            {{ external_links.github_raw }}/percent/validationdynamic/MyExample328Service.java:doUpdateEntity
            --8<--
            ```   
            === "List widget"
                ...
                ```json
                --8<--
                {{ external_links.github_raw }}/percent/validationdynamic/MyExample328List.widget.json
                --8<--
                ```
            === "Info widget"
                **_not applicable_** 
            === "Form widget"
                ```json
                --8<--
                {{ external_links.github_raw }}/percent/validationdynamic/MyExample328Form.widget.json
                --8<--
                ```
## Sorting
...
??? Example
    ...
    ```java
    --8<--
    {{ external_links.github_raw }}/percent/required/MyExample8Meta.java:buildRowDependentMeta
    --8<--
    ```   
    === "List widget"
        **Works for List.**
...
??? Example
    === "List widget"
        ...
        ```json
        --8<--
        {{ external_links.github_raw }}/percent/additionalproperties/digits/MyExample310List.widget.json
        --8<--
        ```
    === "Info widget"
        Add **digits** to **_.widget.json_**.
        ```json
        --8<--
        {{ external_links.github_raw }}/percent/additionalproperties/digits/MyExample310Info.widget.json
        --8<--
        ```
    === "Form widget"
        Add **digits** to **_.widget.json_**.
        ```json
        --8<--
        {{ external_links.github_raw }}/percent/additionalproperties/digits/MyExample310Form.widget.json
        --8<--
        ```
...
??? Example
    === "List widget"
        ...
        ```json
        --8<--
        {{ external_links.github_raw }}/percent/additionalproperties/nullable/MyExample58List.widget.json
        --8<--
        ```   
    === "Info widget"
        _not applicable_  
    ...
    === "Form widget"
        ...
        ```json
        --8<--
        {{ external_links.github_raw }}/percent/additionalproperties/nullable/MyExample58Form.widget.json
        --8<--
        ```  
